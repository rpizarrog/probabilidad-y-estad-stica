...
```{r}
datos_a_visualizar <- datos_a_visualizar[!is.na(datos$publications),]
datos_a_visualizar <- datos_a_visualizar[!is.na(datos$acceptance_num),]
...
```{r}
datos_a_visualizar <- datos_a_visualizar[!is.na(datos$publications),]
datos_a_visualizar <- datos_a_visualizar[!is.na(datos$rank),]
