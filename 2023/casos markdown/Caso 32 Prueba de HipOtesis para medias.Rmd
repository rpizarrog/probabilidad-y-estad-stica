---
title: "Caso 32. Prueba de Hipótesis para medias"
...
El valor de la media debe estar en el intervalo `r as.numeric(prueba_hip$conf.int[1])` y `r as.numeric(prueba_hip$conf.int[2])` en un $95\%$ de nivel de confianza, habiendo hecho la prueba de dos colas (`r prueba_hip$alternative`).
...
## Prueba de hipótesis de t cola izqierda

pendiente

## Prueba de hipótesis de t cola derecha
